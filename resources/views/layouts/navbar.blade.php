        ...
        <div class="hidden lg:flex justify-between items-center text-sm">
            <div class="flex items-center space-x-8">
                <div class="flex items-center">
                    <i class="far fa-clock mr-3 text-[#3A9E1E]"></i>
                    <span>8:00AM - 5:00PM</span>
                </div>
                <div class="flex items-center">
                    <i class="fas fa-phone mr-3 text-[#3A9E1E]"></i>
                    <span>+62 0857 5928 8760</span>
                </div>
                <div class="flex items-center">
                    <i class="far fa-envelope mr-3 text-[#3A9E1E]"></i>
                    <span>wastejourney@gmail.com</span>
                </div>
                <div class="flex items-center">
                    <i class="fas fa-map-marker-alt mr-3 text-[#3A9E1E]"></i>
                    <span>Jl. Cibankong, Kota Bandung, Jawa Barat</span>
                </div>
            </div>
            <div class="flex items-center space-x-6">
                <a href="#" class="hover:text-[#3A9E1E]"><i class="fab fa-facebook-f"></i></a>
